...
func (_ ValueFunction) Display() (string, *VmInterrupt) {
	return "<function>", nil
}

func (_ ValueFunction) IsEqual(other Value) (bool, *VmInterrupt) {
	return false, nil
}

func (_ ValueFunction) Fields() (map[string]*Value, *VmInterrupt) {
